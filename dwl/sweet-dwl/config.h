...
static const float bordercolor[]           = COLOR(0x5588aaff);
...
static const char *screenshot_copy[] = {"screenshot_copy.sh", NULL};
...
/* Monitor Brightness */
static const char *light_up[]   = { "/usr/bin/brightnessctl",   "s", "+30", NULL };
static const char *light_down[] = { "/usr/bin/brightnessctl",   "s", "30-", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_S,	         spawn,		 {.v = screenshot_copy}},
	{ MODKEY,                    XKB_KEY_p,          spawn,          {.v = rofi} },
